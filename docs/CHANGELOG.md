...
- Fix: admin contacts API – parametrizzazione query raw con `Prisma.sql`, builder condiviso per i filtri e clamp numerico su `LIMIT/OFFSET`.【F:src/lib/admin/contacts-query.ts†L1-L146】【F:src/app/api/admin/contacts/route.ts†L1-L116】
