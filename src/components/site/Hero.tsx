      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 py-20 text-slate-100 md:px-6 md:py-28">
        ...
        <div className="max-w-3xl space-y-6">
          ...
          <p className="max-w-[60ch] text-lg leading-relaxed text-slate-200 md:text-xl">
            Il 31 ottobre, il Bar La Soluzione si trasforma in un luogo di mistero e divertimento.<br />DJ set, cocktail spettrali, specialità messicane e per i bimbi merenda, face painting, maschere e tanti giochi.<br />Posti limitati, prenota per non perdere l&apos;evento più spaventoso dell&apos;anno!
          </p>
